...
function Transformer(obj) {
  ...
  this.outputFormats = obj.outputFormats;
  this.outputFormat = obj.outputFormats[0];
  this._cache = {};
  ...
  if (this.isMinifier){
    self = this;
    this.outputFormats.forEach(function(format){
      minifiers[format] = self;
    });
  } else {
    this.minify = function(str, options) {
      var minifier = minifiers[this.outputFormat];
      if (minifier && options && options.minify) {
